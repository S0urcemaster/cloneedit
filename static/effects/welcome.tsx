...
export const effect_welcome: Effect = {
      ...
      update: (text: string) => {
         if(text) {
            return `This is a serverless app (so far) ! Nothing you type is being sent over network ! Checkout the Developer Tools on key F12 and there the network tab to be sure !`
         }
